...
//! Source: `Interface '/org/freedesktop/NetworkManager' from service
...
pub trait NetworkManager {
    ...
    fn network_state(&self) -> zbus::Result<NetworkState>;
    ...
    //     &self,
    //     value: std::collections::HashMap<String, &zbus::zvariant::Value<'_>>,
    // ) -> zbus::Result<()>;
